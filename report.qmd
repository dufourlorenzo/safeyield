...
subtitle: "Big Data Technology, CLSBE"
...
|-----------|------------------------|
| **Volume** | `{python} f"{n_fires:,}"` fire events and `{python} f"{n_houses:,}"` property records across four decades, totalling roughly `{python} f"{total_ha/1e6:.1f}"` million hectares of cumulative burned area across all recorded events. |
...
Fire activity concentrates in the central and northern interior. This provides insight into the spatial distribution of wildfire risk. The five districts that account for the largest cumulative burn footprint are listed below.
